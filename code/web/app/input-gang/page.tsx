...
//   // Step from URL (?step=1|2)
//   const initialStep = Number(search.get("step")) === 2 ? 2 : 1;
//   const [step, setStep] = useState<1 | 2>(initialStep);

//   // Keep URL in sync when step changes (no scroll jump)
//   useEffect(() => {
...
//             {step === 1 ? (
//               <div className="bg-[#FFFDF5] rounded-2xl px-5 py-5 mx-3">
...
//                 {/* Lebar Gang */}
//                 <label className="mt-4 block text-sm font-medium text-[#2E4270]">
//                   Lebar Gang
//                 </label>
...
//       {/* labels */}
//       <div className="text-center p-2" style={{ gridColumn: 1, gridRow: 2 }}>
